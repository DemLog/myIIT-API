    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Email Moodle')),
                ('password', models.CharField(max_length=64, verbose_name='Пароль Moodle')),
                ('user_id', models.IntegerField(unique=True, verbose_name='ID VK')),
